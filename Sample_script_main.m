...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%
sim_frames=1e2; % For results shown in the paper, the simulation is carried out at a compute farm with 10^5 frames per SNR per algorithm 
                % until the reserved computing time is reached. In addition, the number of iterations per realizaiton is set to 500
                % while the early termination is disabled. 
